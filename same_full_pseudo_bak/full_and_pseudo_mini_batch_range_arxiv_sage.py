	...
	for run in range(args.num_runs):
		...
		for epoch in range(args.num_epochs):
			...
			if args.load_full_batch:
				...
				file_name=r'/home/cc/graph_partition_multi_layers/DATA/re/fan_out_'+args.fan_out+'/'+args.dataset+'_'+str(epoch)+'_items.pickle'
...
#---------------------------------------------------------------------------------------
	...
	argparser.add_argument('--batch-size', type=int, default=45471) # ogbn-arxiv 2
...
#--------------------------------------------------------------------------------------
	...
	argparser.add_argument("--weight-decay", type=float, default=5e-3,
